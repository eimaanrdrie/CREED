"""UI-R37 Knowledge proof-stack component-width overflow sweep using CREED CSS."""
from pathlib import Path
import json,re,shutil,sys
ROOT=Path(__file__).resolve().parents[1]
CSS=(ROOT/'frontend/app/globals.css').read_text(encoding='utf-8')
HARNESS=(ROOT/'scripts/fixtures/ui_r37_knowledge_harness.html').read_text(encoding='utf-8')
try:
...
with sync_playwright() as p:
    ...
    page=browser.new_page(viewport={'width':1500,'height':9000})
...
print('UI-R37 Knowledge proof-stack browser sweep: PASS')
